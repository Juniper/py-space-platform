...
<head>
    ...
    <title>Coverage for /Library/Python/2.7/site-packages/http/client: 100%</title>
...
<div id='header'>
    <div class='content'>
        <h1>Coverage for <b>/Library/Python/2.7/site-packages/http/client</b> :
...
<p id='t4' class='stm run hide_run'><span class='key'>assert</span> <span class='nam'>sys</span><span class='op'>.</span><span class='nam'>version_info</span><span class='op'>[</span><span class='num'>0</span><span class='op'>]</span> <span class='op'>&lt;</span> <span class='num'>3</span><span class='strut'>&nbsp;</span></p>
<p id='t5' class='pln'><span class='strut'>&nbsp;</span></p>
<p id='t6' class='stm run hide_run'><span class='key'>from</span> <span class='nam'>httplib</span> <span class='key'>import</span> <span class='op'>*</span><span class='strut'>&nbsp;</span></p>
